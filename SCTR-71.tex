...
an LSST milestone pertaining to the EPO Subsystem.\\
...
\smallskip
See the attached screen recording in docushare:
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-40981/Screen\%20Recording\%202022-08-26\%20at\%209.37.23\%20AM.mov}{\textbf{Screen
Recording 2022-08-26 at 9.37.23 AM.mov}}
\medskip
\end{minipage}
&   \\\hline
\href{https://jira.lsstcorp.org/secure/Tests.jspa#/testCase/LVV-T2315}{LVV-T2315}
...
\begin{minipage}[]{9cm}
\smallskip
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-40975/EPO\%20-\%20Google\%20Cloud\%20-\%20Req\%20Ver.mp4}{\textbf{EPO
...
\begin{minipage}[]{9cm}
\smallskip
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-40976/Citizen\%20Science\%20and\%20RSP\%20Test\%20Execution.mp4}{\textbf{Citizen
...
\begin{minipage}[]{9cm}
\smallskip
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43311/Requirement\%20Verification\%20for\%20EPO-REQ-0251.pdf}{\textbf{Requirement
...
\begin{minipage}[]{9cm}
\smallskip
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3045}{EDC Data
...
\begin{minipage}[]{9cm}
\smallskip
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-40976/Citizen\%20Science\%20and\%20RSP\%20Test\%20Execution.mp4}{Citizen
...
\smallskip
See the attached screen recording in docushare:
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41049/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}}
\medskip
\end{minipage}
&   \\\hline
...
\smallskip
See the attached screen recording in docushare:
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41056/Screen\%20Recording\%202022-09-09\%20at\%204.14.11\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.14.11 PM.mov}}\\
See the attached screen recording in docushare:
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41057/Screen\%20Recording\%202022-09-09\%20at\%204.22.06\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.22.06 PM.mov}}
\medskip
\end{minipage}
&   \\\hline
\href{https://jira.lsstcorp.org/secure/Tests.jspa#/testCase/LVV-T2638}{LVV-T2638}
...
\smallskip
See the attached screen recording in docushare:
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41065/Screen\%20Recording\%202022-09-09\%20at\%204.51.21\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.51.21 PM.mov}}\\
See the attached screen recording in docushare:
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43315/Screen\%20Recording\%202022-09-23\%20at\%208.18.01\%20AM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.51.21 PM.mov}}
\medskip
\end{minipage}
&   \\\hline
...
There are two verification tickets still open for verification in order
to verify \citeds{LSE-89} requirements (EPO-REQ-0188,EPO-REQ-0189) at the end of
the construction phase. For EPO-REQ-0188, a 3D telescope tour experience
can not be provided until the primary construction of the observatory
finishes. This verification ticket is already traced to a test case
(LVV-T1931) with a preliminary step defined. EPO-REQ-0189 requirement's
goal is to provide a fulldome projection of the LSST night sky above the
observatory and highlighting the alert stream data. However, the alert
stream data will not exist prior to the completion of the EPO
Construction project. Hence, the EPO team delivered the first part of
the requirement which is a fulldome projection of the night sky
(verification ticket - LVV-19000). Additionally, most planetaria will
not require near real-time updates of their materials. The EPO team can
work to complete the second part of the requirement by providing a
subset of the alert stream data for overlaying event detection in
FY23.The verification ticket (LVV-20575) is available in the Rubin
Verification system to verify the alert stream data portion of the
requirement.

Future DM verification at construction end should re-confirm with
services in their final states. In particular, EPO will still have need
for DM software and services such as, the Image Cutout service with an
image formatter capable of writing EXIF metadata, the Butler Server to
replace the EPO Data Center's stand-alone instance of the Butler
service, and a DM Pipeline task that makes a HiPS image survey available
in non-scientific but visually appealing color bands.The needs of these
services extends to access to any databases, object stores,
firewalls/VPCs, etc. required to access and use such DM software and
services.~

The requirements in relation to Data Rights Panel (EPO-REQ-0179) and
Project Launch Panel (EPO-REQ-0180) are verified with deviation
``accept-as-is'' by providing the policies for the formation and
activities to be ~performed in anticipation of the first available Rubin
data. So, it is recommended that those panels be created following the
guidelines and policies provided by the EPO team as soon as the
commissioning/survey validation data becomes available. For the
diversity requirement(EPO-REQ-0276), the EPO team only could provide the
policies for ~gender neutrality of content as the complete scenario of
the contents in the EPO portal could not be achieved and viewed until
the launch of the EPO portal. It is suggested that when there is enough
content in the EPO portal, a review should be conducted to confirm the
diversity of gender neutral content policies are in effect.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached sreengrab starting at 00:00
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached sreengrab starting at 01:05
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached sreengrab starting at 01:26
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached sreengrab starting at 02:17
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
GraphQL API sandbox loaded free of errors (see attached screengrab)~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Test object IDs all yielded expected results from queries (see attached
screengrab)
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Explore page loads as expected (see attached screengrab)
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 00:00
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 00:13
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 00:36
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 00:49
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 00:55
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 01:04
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 01:10
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 01:17
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 01:33
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 01:17 and 03:35
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 02:00
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 02:30
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 02:40
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 04:14
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached sreengrab starting at 02:45
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 02:45
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
See attached screengrab starting at 03:02
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The correct document loads. A pdf of this document has been attached to
the test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Interviews exists and details interviews conducted by the
EPO team during Construction. All provided links function. PDF of static
document attached to test case.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Surveys exists and details surveys conducted by the EPO team
during Construction. All provided links function. PDF of static
documents attached to test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Focus Groups exists and details focus groups conducted by
the EPO team during Construction. All provided links function. PDF of
static documents attached to test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Outreach Training exists and details trainings conducted by
the EPO team during Construction. Links to records of the outreach
training sessions are provided. All provided links function.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Professional Development (Online) exists and details
professional development events conducted by the EPO team during
Construction. Links to records of the events are provided. Links
function and the linked document is attached as a pdf to this test
case.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Professional Development (In Person) exists and details
professional development events conducted by the EPO team during
Construction. Links to records of the events are provided. Links
function and the linked document is attached as a pdf to this test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Professional Development Feedback Form exists and
demonstrates the feedback form used at all professional development
events. ~Links function and the survey document is attached as a pdf to
this test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Classroom Demographics exists and details the demographics
of student and teacher participants in EPO testing. Links to
demographics reports function and pdfs of these records are attached to
the test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Opportunities to Contribute Data exists and events wherein
the community was invited to contribute data by the EPO team during
Construction. Links to the given presentations are provided and the
presentations are attached as pdfs to the test case. All provided links
function.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Community Network exists and details the events wherein EPO
promoted the EPO program and worked to raise awareness of its
components. ~Links to records of the events are provided for the
education program. ~All provided links function and linked documents are
attached as pdfs to the test case.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Moderated UI Design exists and details the ways in which the
EPO sought feedback on the UI design of the website. Links to records of
the outreach training sessions are provided and records are attached as
pdfs to the test case. All provided links function.\\[2\baselineskip]As
captured in the deviation request, these surveys were not explicitly
conducted on desktop, tablet, and mobile.Those surveyed were allowed to
use the device of their choice and EPO expects all three types of
devices were likely used. All feedback received was applied to the
design and implementation of all three device types.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Results Reporting exists and details times when results were
reported by the EPO team during Construction. Links to records of these
report presentations are included and pdfs of the presentations are
available in Docushare. All provided links function.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section Partnerships exists and details partnerships entered into by
the EPO team during Construction. The document outlines who the
partnership was with and what it hoped to achieve. The results of these
partnerships are linked throughout the document - primarily the
accessibility reports, the user testing reports, and the pilot testing
reports.\\[2\baselineskip]A table is included that summarizes these
partnerships and how they meet the required number of different types of
institutions is clearly laid out.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The code is visible on GitHub and the ability to clone, branch, and fork
are available. A screenshot of the repo and the clone option is
attached.\\
\includegraphics[width=3.12500in]{jira_imgs/3185.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The README loads as expected. It outlines dependencies for the package
if I wanted to use it and how to run the code. A pdf of the README file
is attached to the test case.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Github Issues loads as expected. I can see all open issues on the
repository - what the issue is and what the suggested solution is. I can
also easily contribute my own issues with no problem. Screenshots of the
issues board and my ability to create an issue are attached below.\\
\includegraphics[width=3.12500in]{jira_imgs/3187.png}\\
\includegraphics[width=3.12500in]{jira_imgs/3188.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
History of past, completed pull requests and open pull requests are
publicly available. I also have the ability to create a pull request.
Both the list of pull requests and my ability to create a new one are
captured in screenshots below.\\
\includegraphics[width=3.12500in]{jira_imgs/3189.png}\\
\includegraphics[width=3.12500in]{jira_imgs/3190.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
As a member of the EPO team and repository, I have access to the Github
projects. This project exists and loads. It clearly outlines issues to
be addressed, issues currently under development, and issues that are
completed. Screenshot attached below.\\
\includegraphics[width=3.12500in]{jira_imgs/3191.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The document loads from the link provided. The document clearly lays out
how all six EPO classroom investigations align with the curriculum
nacional in Chile. The document is attached as a pdf to this test
case.\\[2\baselineskip]As laid out in the deviation request, the
requirement calls for the program to align with outdated education
standards. The program now aligns with the current education standards
in Chile.~\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Google document loads and outlines EPO's gender neutrality policy.
In particular, it outlines the ways EPO commits to using gender neutral
language. A pdf of the policy is attached to this test case.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
This Docushare collection includes all of the presentations given as
part of the EPO Acceptance Review in 2017.\\[2\baselineskip]The pdf
attached to this test case summarizes the outcome of the Acceptance
Review. It demonstrates that EPO successfully passed the review and
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Visiting the webpage brings up a table outlining how the Solar System
investigation aligns with the NGSS standards.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The webpage loads and clearly outlines how the Surveying the Solar
System investigation aligns with the NGSS standards. A pdf of the
webpage is attached to the test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Google document loads and clearly outlines how the Expanding
Universe investigation aligns with the NGSS standards. A pdf of the
document is attached to the test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Google document loads and clearly outlines how the Coloring the
Universe investigation aligns with the NGSS standards. A pdf of the
document is attached to the test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Google document loads and clearly outlines how the Exploding Stars
investigation aligns with the NGSS standards. A pdf of the document is
attached to the test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Google document loads and clearly outlines how the Exploring the
Observable Universe investigation aligns with the NGSS standards. A pdf
of the document is attached to the test case.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Google document loads and clearly outlines how the Hazardous
Asteroids investigation aligns with the NGSS standards. A pdf of the
document is attached to the test case.\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
A web browser opens on the internet-connected device\\[6\baselineskip]
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 11 & Step Execution Status: \textbf{ Pass w/ Deviation } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
...
variables are stored loaded in the browser.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section where scaling variables are stored was visible on the page.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
A web browser opened up on the internet-connected device
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Jupyter Notebook will download
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
A web browser opened on the device.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The README.md contained sufficient instructions on how to load the
notebooks in the browser
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The notebook loaded in the browser.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Output from the cell execution informed the user that their data is
being sent to Zooniverse.
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 14 & Step Execution Status: \textbf{ Pass w/ Deviation } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Verify that the full batch has been loaded by the Zooniverse platform.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The document in question is attached to this test case and can also be
found at this link:\\
https://docs.google.com/document/d/1c-lpWRjtCvRKRc25roKXz9Sa27G7NKZNAwZ1jP2tAhA/edit?usp=sharing\\[2\baselineskip]The
analytics agreement outlines key metrics that will be provided to EPO
for citizen science projects. It is agreed that the metrics will be
provided to support all EPO reporting needs.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The notebook was successfully cloned into my local computer.\\
\includegraphics[width=3.12500in]{jira_imgs/3246.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The first lines through loading the Panoptes client and creating the
images ran successfully. See attached pdf attached to test case. .~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The code failed to send the data to Zooniverse because it lacked the
correct credentials as expected. See the the pdf attached to the test
case.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Following the link takes you to the Github repository for the code. All
the code and files are accessible. Screenshot of the repository
attached.\\
\includegraphics[width=3.12500in]{jira_imgs/3243.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Clicking on the file ``License'' in the repository clearly outlines the
MIT license. A screenshot of this file is attached below. ~The MIT
license is also visible from the repo home page as seen in the
screenshot in the above step.\\
\includegraphics[width=3.12500in]{jira_imgs/3244.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The repository can be traversed online and cloned to the users desktop
following standard github procedures\\
\includegraphics[width=3.12500in]{jira_imgs/3245.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The expected document loads. The document is also attached as a pdf to
this test case.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section ``Citizen Science Data Rights Panel'' outlines the minimum
required members.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section outlines the high level considerations of the panel for
proprietary versus non-proprietary data. It also enumerates the required
materials that the panel would like to review.\\[2\baselineskip]This
policy outlines the purview and composition of the panel. However, this
panel has not been convened. This deviation is captured in the linked
deviation request.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section ``Project Readiness Panel'' outlines the minimum required
members.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The section ``How to Launch Your Project'' outlines the high level
procedure a PI would follow in order to gain full Rubin project
authorization. It also enumerates the kinds of considerations and
materials that the panel would like to review.\\[2\baselineskip]This
policy outlines the purview and composition of the panel. However, this
panel has not been convened. This deviation is captured in the linked
deviation request.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Tester Lauren Corlies was able to successfully log in to rubin.canto.com
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The EPO DAM is populated with EPO multimedia assets. All links along the
left are active and show the expected content. A screenshot of the DAM
is included here.\\
\includegraphics[width=1.56250in]{jira_imgs/3142.png}\\
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Clicking on the Gallery link at the top of rubinobs.org takes me to the
online, public gallery. A screenshot of the working gallery is
included.\\[2\baselineskip]\includegraphics[width=3.12500in]{jira_imgs/3150.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
As in the step and screenshot above, the online gallery loads.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Clicking on the link loads the Rubin Observatory YouTube channel.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The playlist of animated videos is in Standard format. The playlist is
found at this link:\\
https://www.youtube.com/watch?v=NUwV\_vc9fik\&list=PLPINAcUH0dXbEQbSMDSKilynCN\_KdEVyy\\[2\baselineskip]and
a screen shot of the first video in standard format is below.\\
\includegraphics[width=3.12500in]{jira_imgs/3144.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The portal at the given link loads as
expected.\\[2\baselineskip]Screenshot showing portal of assets:\\
\includegraphics[width=3.12500in]{jira_imgs/3145.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The videos are in full-dome format. A screenshot demonstrating one of
the videos is below:\\
\includegraphics[width=3.12500in]{jira_imgs/3146.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The image gallery loads as expected.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The first image loaded and is shown below\\
\includegraphics[width=3.12500in]{jira_imgs/3147.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The image has Spanish caption title and description as expected on the
right hand side of the screen.~\\
\includegraphics[width=3.12500in]{jira_imgs/3148.png}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Dropbox folder loads as expected.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
As shown in the screenshot, every video that was created in English was
also created in Spanish.\\
\includegraphics[width=3.12500in]{jira_imgs/3149.png}
...
{\footnotesize
See
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-43120/Screen\%20Recording\%202022-11-04\%20at\%203.24.14\%20PM.mov}{screen
recording} starting at 00:00
...
{\footnotesize
See
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41011/Screen\%20Recording\%202022-09-16\%20at\%209.28.28\%20AM.mov}{screengrab}
starting at 00:00
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41012/Screen\%20Recording\%202022-09-16\%20at\%209.42.04\%20AM.mov}{screengrab}
starting at 00:00
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41013/Screen\%20Recording\%202022-09-16\%20at\%209.53.37\%20AM.mov}{screengrab}
starting at 00:00
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The data collected from users in the user testing sessions is well
organized, methods used to collect are credible, and a clear line can
drawn between feedback collected \& received, features \& bug fixes
identified \& addressed in subsequent release, and testing again. ~This
empathize, define, ideate, prototype, test, REPEAT approach is a tried
and true method of iterative prototyping widely adopted across the
industry and in the sciences, and is in line with EPO's overall approach
to creating programming and resources.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Reports include valuable information about the user, their device, and
testing environment, as well as critical feedback itself. ~All testing
was intended to be completed on desktop computers.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The For Scientists page includes info and links to the Rubin Science
Platform, the Community Forum, and Citizen Science projects
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Attached report does indicate that publishing posts across Rubin social
media channels averages \textgreater{}= daily new content
...
{\footnotesize
see attachment
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-41058/Screen\%20Recording\%202022-09-07\%20at\%202.55.09\%20PM.mov}{Screen
Recording 2022-09-07 at 2.55.09 PM.mov} to confirm client-side
dependencies are tracked, defined, and version locked.
...
see attachment
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-41058/Screen\%20Recording\%202022-09-07\%20at\%202.55.09\%20PM.mov}{Screen
Recording 2022-09-07 at 2.55.09 PM.mov} to confirm client-side source
and dependencies are automatically scanned by dependbot, that dependbot
is providing suggested updates, alerts to deprecations, etc., and that
recommended remediations have been made and dependbot issues closed
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
see~\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-41059/Screen\%20Recording\%202022-09-07\%20at\%202.59.40\%20PM.mov}{Screen
Recording 2022-09-07 at 2.59.40 PM.mov} at 00:15
...
{\footnotesize
see
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-41059/Screen\%20Recording\%202022-09-07\%20at\%202.59.40\%20PM.mov}{Screen
Recording 2022-09-07 at 2.59.40 PM.mov} at 00:30
...
see
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-41059/Screen\%20Recording\%202022-09-07\%20at\%202.59.40\%20PM.mov}{Screen
Recording 2022-09-07 at 2.59.40 PM.mov} at 00:45
...
see
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-41059/Screen\%20Recording\%202022-09-07\%20at\%202.59.40\%20PM.mov}{Screen
Recording 2022-09-07 at 2.59.40 PM.mov} at 01:06
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
the homepage includes all of the expected content and UI and the page
does in fact load in \textless{}= 2 secs (see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41040/Screen\%20Recording\%202022-09-09\%20at\%202.38.19\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 2.38.19 PM.mov}})
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
All links were checked, the attached screengrab
(\textbf{\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3085}{Screen
Recording 2022-09-09 at 2.41.41 PM.mov}}) demonstrates a selection (i.e.
some but not all) of nav links redirecting to the specified pages
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41053/Screen\%20Recording\%202022-09-09\%20at\%202.49.37\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 2.49.37 PM.mov}}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41052/Screen\%20Recording\%202022-09-09\%20at\%202.52.27\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 2.52.27 PM.mov}}
...
{\footnotesize
see
screengrab:~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41048/Screen\%20Recording\%202022-09-09\%20at\%202.56.41\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 2.56.41 PM.mov}}
...
{\footnotesize
see
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41047/Screen\%20Recording\%202022-09-09\%20at\%203.02.38\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.02.38 PM.mov}}
...
{\footnotesize
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41047/Screen\%20Recording\%202022-09-09\%20at\%203.02.38\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.02.38 PM.mov}}~starting at 0:14
...
{\footnotesize
see
screengrab:~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43312/Screen\%20Recording\%202022-09-09\%20at\%203.10.37\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.10.37 PM.mov}}
...
{\footnotesize
see screengrab:
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43312/Screen\%20Recording\%202022-09-09\%20at\%203.10.37\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.10.37 PM.mov}} 00:27
...
see screengrab:
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43312/Screen\%20Recording\%202022-09-09\%20at\%203.10.37\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.10.37 PM.mov}} at 01:40
...
{\footnotesize
see
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41043/Screen\%20Recording\%202022-09-09\%20at\%203.19.04\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.19.04 PM.mov}}
...
{\footnotesize
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41043/Screen\%20Recording\%202022-09-09\%20at\%203.19.04\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.19.04 PM.mov}} at 00:10
...
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41043/Screen\%20Recording\%202022-09-09\%20at\%203.19.04\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.19.04 PM.mov}} 00:20
...
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41043/Screen\%20Recording\%202022-09-09\%20at\%203.19.04\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.19.04 PM.mov}} at 00:55
...
{\footnotesize
see
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41042/Screen\%20Recording\%202022-09-09\%20at\%203.20.40\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.20.40 PM.mov}}
...
{\footnotesize
see
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41044/Screen\%20Recording\%202022-09-09\%20at\%203.43.19\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.43.19 PM.mov}}
...
{\footnotesize
see
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41054/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}}
...
{\footnotesize
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41054/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}} at 00:20
...
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41054/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}} at 00:35
...
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41054/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}} at 01:20
...
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41054/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}} at 00:30
...
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41054/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}} at 01:30
...
see screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41049/Screen\%20Recording\%202022-09-09\%20at\%203.49.35\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.49.35 PM.mov}} 02:13
...
{\footnotesize
see attached
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41056/Screen\%20Recording\%202022-09-09\%20at\%204.14.11\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.14.11 PM.mov}}
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41057/Screen\%20Recording\%202022-09-09\%20at\%204.22.06\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.22.06 PM.mov}}~00:14
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41057/Screen\%20Recording\%202022-09-09\%20at\%204.22.06\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.22.06 PM.mov}} 00:30
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41057/Screen\%20Recording\%202022-09-09\%20at\%204.22.06\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.22.06 PM.mov}} 00:45
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41057/Screen\%20Recording\%202022-09-09\%20at\%204.22.06\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.22.06 PM.mov}}~00:50
...
{\footnotesize
see attached
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41055/Screen\%20Recording\%202022-09-09\%20at\%204.29.20\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.29.20 PM.mov}}
...
{\footnotesize
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41055/Screen\%20Recording\%202022-09-09\%20at\%204.29.20\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.29.20 PM.mov}} at 00:15
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41055/Screen\%20Recording\%202022-09-09\%20at\%204.29.20\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.29.20 PM.mov}} at 00:33
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41055/Screen\%20Recording\%202022-09-09\%20at\%204.29.20\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.29.20 PM.mov}} at 01:12
...
{\footnotesize
see attached
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41060/Screen\%20Recording\%202022-09-09\%20at\%204.35.03\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.35.03 PM.mov}}
...
{\footnotesize
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41060/Screen\%20Recording\%202022-09-09\%20at\%204.35.03\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.35.03 PM.mov}} at 01:00
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41060/Screen\%20Recording\%202022-09-09\%20at\%204.35.03\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.35.03 PM.mov}} at 02:50
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41060/Screen\%20Recording\%202022-09-09\%20at\%204.35.03\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.35.03 PM.mov}} at 03:15
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41060/Screen\%20Recording\%202022-09-09\%20at\%204.35.03\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.35.03 PM.mov}} at 03:28
...
{\footnotesize
see
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41063/Screen\%20Recording\%202022-09-09\%20at\%203.24.27\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 3.24.27 PM.mov}}
...
{\footnotesize
see attached
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41064/Screen\%20Recording\%202022-09-09\%20at\%204.44.31\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.44.31 PM.mov}}
...
{\footnotesize
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41064/Screen\%20Recording\%202022-09-09\%20at\%204.44.31\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.44.31 PM.mov}} at 00:20
...
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41064/Screen\%20Recording\%202022-09-09\%20at\%204.44.31\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.44.31 PM.mov}} at 01:00
...
{\footnotesize
see attached
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41065/Screen\%20Recording\%202022-09-09\%20at\%204.51.21\%20PM.mov}{Screen
Recording 2022-09-09 at 4.51.21 PM.mov}
...
{\footnotesize
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41065/Screen\%20Recording\%202022-09-09\%20at\%204.51.21\%20PM.mov}{Screen
Recording 2022-09-09 at 4.51.21 PM.mov}
...
{\footnotesize
see attached
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43315/Screen\%20Recording\%202022-09-23\%20at\%208.18.01\%20AM.mov}{Screen
Recording 2022-09-23 at 8.18.01 AM.mov}
...
{\footnotesize
see attached screengrab
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43315/Screen\%20Recording\%202022-09-23\%20at\%208.18.01\%20AM.mov}{Screen
Recording 2022-09-23 at 8.18.01 AM.mov}
...
{\footnotesize
se attached
screengrab~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41066/Screen\%20Recording\%202022-09-09\%20at\%204.53.48\%20PM.mov}{\textbf{Screen
Recording 2022-09-09 at 4.53.48 PM.mov}}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The report is detailed and confirms the overall compliance of the site
at date seen in the supplied screenshot
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Github issues contain direct reference back to the violations as they
are found in the levelaccess reports, calling out both the violation and
potential remediations varbatim. ~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
These github issues are all resolved with linked PRs/commits verifiably
merged into tagged branch deployed to prod.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Can confirm much progress has been made reducing overall number of
violations, coming into line with WCAG 2.0 level AA requirements, and
that the overall score has improved with all the content and code
revisions.
...
{\footnotesize
See
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-40987/Screen\%20Recording\%202022-09-14\%20at\%203.42.03\%20PM.mov}{screengrab}
at 00:04
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41005/Screen\%20Recording\%202022-09-15\%20at\%201.19.58\%20PM.mov}{screengrab}
starting at 00:00
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41006/Screen\%20Recording\%202022-09-15\%20at\%201.23.46\%20PM.mov}{screengrab}
starting at 00:00
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41007/Screen\%20Recording\%202022-09-15\%20at\%201.27.44\%20PM.mov}{screengrab}
starting at 00:00
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41008/Screen\%20Recording\%202022-09-15\%20at\%204.38.22\%20PM.mov}{screengrab}
starting at 00:13
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41009/Screen\%20Recording\%202022-09-15\%20at\%204.59.50\%20PM.mov}{screengrab}
starting at 00:00
...
{\footnotesize
see
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-41010/Screen\%20Recording\%202022-09-16\%20at\%209.16.05\%20AM.mov}{screengrab}
starting at 00:00
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3340}{Citizen\_Science\_Testing\_101322.pdf}
shows all of the code blocks executed as expected in the jupyter
notebook; page 1 of
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3341}{zooniverse\_email\_cutouts\_101322.pdf}
shows the email notification verifying 100 objects were sent to
Zooniverse
...
{\footnotesize
page 2 of
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3336}{zooniverse\_email\_cutouts\_101322.pdf}
shows the data set specified in the email notification available in the
Zooniverse project builder UI.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3337}{Citizen\_Science\_Testing\_executed.pdf}
shows all of the code blocks executed as expected in the jupyter
notebook;
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3338}{Zoo\_email.pdf}~shows
the email notification verifying 100 objects were sent to Zooniverse
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3339}{Zooniverse\_SubjectSet.pdf}~shows
the data set specified in the email notification available in the
Zooniverse project builder UI.
...
{\footnotesize
See
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43309/Screen\%20Recording\%202022-10-21\%20at\%202.17.30\%20PM.mov}{\textbf{Screen
Recording 2022-10-21 at 2.17.30 PM.mov}} starting at 00:00
...
See
\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43309/Screen\%20Recording\%202022-10-21\%20at\%202.17.30\%20PM.mov}{\textbf{Screen
Recording 2022-10-21 at 2.17.30 PM.mov}} starting at 00:00 starting at
00:04
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
A 3D model of the solar system exists, is populated from simulated data
as provided by the Solar System Collaboration (precursor DP1 data set),
and includes content, functionality and UI comparable to the EPO
\href{https://skyviewer-client-dot-skyviewer.uw.r.appspot.com/}{Skyviewer
app}.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
see~\href{https://docushare.lsstcorp.org/docushare/dsweb/Get/Document-43310/Screen\%20Recording\%202022-11-04\%20at\%203.53.24\%20PM.mov}{\textbf{Screen
Recording 2022-11-04 at 3.53.24 PM.mov}} ~for results
...
{\footnotesize
see
\href{https://jira.lsstcorp.org/rest/tests/1.0/attachment/3343}{Screen
Recording 2022-10-21 at 3.03.46 PM.mov}
...
{\footnotesize
see
\href{https://docushare.lsst.org/docushare/dsweb/Get/Document-43121/Screen\%20Recording\%202022-11-04\%20at\%203.40.52\%20PM.mov}{screen
recording} starting at 00:00
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The obfuscated password appears in the password field.\\[6\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The ``edc-prod'' project will load.\\[6\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The Cloud Storage page will load with a listing of
buckets\\[6\baselineskip]
...
{\footnotesize
The ``Bucket details'' page loads in the browser with a listing of the
files within the bucket\\[6\baselineskip]
...
{\footnotesize
The CSV file is downloaded and can be opened in a text editor for
verification of its contents.\\[6\baselineskip]
